<div class="site-shell">
	...
	<section class="hero">
		<div class="hero-panel">
			...
			<div class="hero-actions">
				...
				<a class="button-secondary" href="https://procurement-trying-beside-beginning.trycloudflare.com" target="_blank" rel="noreferrer noopener">打开 AI 站点 | AI Chat</a>
			</div>
		</div>
	...
	<section class="section" id="posts">
		...
		<div class="post-list">
			...
			<a class="list-card post-card" href="https://procurement-trying-beside-beginning.trycloudflare.com" target="_blank" rel="noreferrer noopener">
				<div class="post-body">
					<div class="post-meta">Featured · 精选项目</div>
